...
- **Klip C — `03-cytaty` (~22 s, pion):** 4–5 prawdziwych, anonimowych cytatów (podpis = dzielnica) na przyciemnionych renderach; intro „Z 541 odpowiedzi mieszkańców:". Karty jak `share-pack/cytaty/` lub overlaye fade.
